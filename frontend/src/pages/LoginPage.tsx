...
export default function LoginPage() {
  ...
  const fillDemoCredentials = (role: 'admin' | 'instructor' | 'student') => {
    const credentials = {
      admin: { emailOrUsername: 'admin@skillhub.com', password: 'admin123' },
      instructor: { emailOrUsername: 'john@skillhub.com', password: 'instructor123' },
      student: { emailOrUsername: 'alice@skillhub.com', password: 'student123' },
    }
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
              {loading ? (
                <>
